...
const en = {
  ...
  avgValue: 'avg {value}',
  setEstimateTo: 'Set estimate · {value}',
  estimateSet: 'Estimate set ✓',
  consensus: '🎉 Consensus!',
  hostTitle: 'Host',
...
const fr: Record<MessageKey, string> = {
  ...
  avgValue: 'moy. {value}',
  setEstimateTo: 'Définir l’estimation · {value}',
  estimateSet: 'Estimation définie ✓',
  consensus: '🎉 Consensus !',
  hostTitle: 'Hôte',
...
export const MEME_QUOTES: Record<Lang, readonly string[]> = {
  fr: [
    ...
    '« Pas de tests ? Stratégie audacieuse. »',
    '« Ça compile. Donc ça marche. »',
    '« Ça, c’est un problème pour moi-demain. »',
    '« L’estimation, c’est au feeling. »',
    '« Ça marche en préprod, donc en prod aussi. »',
    '« “Petit correctif” = trois jours minimum. »',
    '« T’as essayé de l’éteindre et de le rallumer ? »',
    '« Le vieux code, on n’y touche pas, il tient tout. »',
  ],
  en: [
    ...
    '“No tests? Bold strategy.”',
    '“It compiles. Ship it.”',
    '“That’s a tomorrow-me problem.”',
    '“The estimate is just a vibe.”',
    '“Works in staging, that’s basically prod.”',
    '“‘Quick fix’ — three days, minimum.”',
    '“Have you tried turning it off and on again?”',
    '“The legacy code is load-bearing.”',
  ],
}
...
export const RESULT_QUIPS: Record<Lang, Record<QuipCategory, readonly string[]>> = {
  fr: {
    consensus: [
      ...
      'Alignés du premier coup. À encadrer.',
      'Unanimité. Quelqu’un fait une capture. 📸',
    ],
    bigSpread: [
      "Quelqu'un n'a pas lu le ticket… 👀",
      'Grand écart olympique. 🤸',
      "Il va falloir qu'on parle.",
      'De 1 à 89… sur le même ticket ? 😅',
      'Un écart à garer un bus dedans. 🚌',
    ],
    coffee: [
      'Pause café générale ! ☕',
      "L'équipe a voté : machine à café.",
      "L'estimation attendra, pas la caféine. ☕",
    ],
    mystery: [
      'Le mystère reste entier. 🔮',
      "Un point d'interrogation vaut mille mots.",
      'Voter « ? » : courageux. 🃏',
      "L'estimation de Schrödinger. 🐱",
    ],
    high: [
      'Aïe. On découpe ? 🔪',
      "C'est un epic déguisé, ça.",
      'On découpe avant que ça nous découpe. 🪓',
      'Au propriétaire de ce ticket : nos condoléances. 🫡',
    ],
    low: [
      'Easy money. 💸',
      'Vite estimé, vite oublié.',
      'Quasiment déjà fait. ✅',
      'Le temps de cligner, c’est livré.',
    ],
    default: [
      'Statistiquement parlant, c’est un résultat.',
      'Les chiffres ont parlé. 📊',
      "Beau travail d'équipe. Ou presque.",
      'De toute façon, on en reparle en rétro.',
    ],
  },
  en: {
    consensus: [
      ...
      'Aligned on the first try. Frame it.',
      'Unanimous. Someone screenshot this. 📸',
    ],
    bigSpread: [
      'Someone didn’t read the ticket… 👀',
      'Olympic-level split. 🤸',
      'We need to talk.',
      'From 1 to 89… same ticket? 😅',
      'A range wide enough to park a bus in. 🚌',
    ],
    coffee: [
      'Coffee break for everyone! ☕',
      'The team has voted: coffee machine.',
      'Estimation can wait, caffeine can’t. ☕',
    ],
    mystery: [
      'The mystery remains. 🔮',
      'A question mark is worth a thousand words.',
      'Bold of you to vote “?”. 🃏',
      'Schrödinger’s estimate. 🐱',
    ],
    high: [
      'Ouch. Shall we split it? 🔪',
      'That’s an epic in disguise.',
      'Break it down before it breaks you. 🪓',
      'To whoever owns this one: condolences. 🫡',
    ],
    low: [
      'Easy money. 💸',
      'Quickly estimated, quickly forgotten.',
      'Practically done already. ✅',
      'Blink and it’s shipped.',
    ],
    default: [
      'Statistically speaking, that’s a result.',
      'The numbers have spoken. 📊',
      'Great teamwork. Almost.',
      'We’ll revisit this in retro anyway.',
    ],
  },
}
